...
interface CheckboxMenuItemRootProps
...
const CheckboxMenuItemRoot = React.forwardRef<
  HTMLButtonElement,
  CheckboxMenuItemRootProps
>(function CheckboxMenuItemRoot(
  {
    disabled = false,
    checked = false,
    hideCheckbox = false,
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={SubframeUtils.twClassNames(
            "flex h-4 w-4 flex-none flex-col items-center justify-center gap-2 rounded-[2px] border-1 border-solid border-neutral-300 group-aria-[checked=true]/de0b4dfb:border group-aria-[checked=true]/de0b4dfb:border-solid group-aria-[checked=true]/de0b4dfb:border-brand-600 group-aria-[checked=true]/de0b4dfb:bg-brand-600 group-disabled/de0b4dfb:border-2 group-disabled/de0b4dfb:border-solid group-disabled/de0b4dfb:border-neutral-200 group-disabled/de0b4dfb:bg-neutral-100",
            { hidden: hideCheckbox }
          )}
        >
...
export const CheckboxMenuItem = CheckboxMenuItemRoot;
